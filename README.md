...
Initially, started creating S3 bucket to store the logic code and frontend code files/objects with name dynamaicapp1 as shown below,
...
DynamoDB created with name (WebAppdata_user) and required configurations applied and primary key as database values designed as emp ID as Primary key.

![image](https://github.com/intuiter/Aws-Serverless-Web-App/assets/135228471/908b2658-6a11-4634-b16c-c28686ab9729)

Then, two Lambda fucntions has been created one named as InsertEmployee API function as a result it will create/update employee details to DynamoDB database as a record and other one Getemployeedetails as a result will fetch details from database and forward to cloud front distribution through API gateway which in return display details to the user.
...
From below figure it is shown that a table record of employee details has been created and updated to database,
